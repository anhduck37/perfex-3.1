...
*
*/
define('APP_BASE_URL', 'https://noibo.hyh.vn/');
...
*/
define('APP_ENC_KEY', '0342969040ecd51b5f96fdace67272ac');
 ...
 */
define('APP_DB_USERNAME', 'eoeziv1v_noibo');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Ug3MbB9Fp7Xb');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'eoeziv1v_noibohyh');
