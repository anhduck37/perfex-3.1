 ...
 * @since 2.0.0
 */
$route['tai-lieu']                   = 'knowledge_base/index';
$route['tai-lieu/tim-kiem']          = 'knowledge_base/search';
$route['tai-lieu/chi-tiet']          = 'knowledge_base/index';
$route['tai-lieu/chi-tiet/(:any)']   = 'knowledge_base/article/$1';
$route['tai-lieu/danh-muc']          = 'knowledge_base/index';
$route['tai-lieu/danh-muc/(:any)']   = 'knowledge_base/category/$1';

/**
 * @deprecated 2.2.0
 */
if (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], 'add_kb_answer') === false) {
    $route['tai-lieu/(:any)']         = 'knowledge_base/article/$1';
    $route['tai-lieu/(:any)']         = 'knowledge_base/article/$1';
